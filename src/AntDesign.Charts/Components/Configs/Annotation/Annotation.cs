...
namespace AntDesign.Charts
{
    public class Annotation : IAnnotation
    {
        ...
        [JsonPropertyName("style")] public IGraphicStyle Style { get; set; }
        [JsonIgnore] public OneOf<object, object[], string[]> Start { get; set; }
        [JsonPropertyName("start")] public object StartMapping => Start.Value;
        [JsonIgnore] public OneOf<object, object[], string[]> End { get; set; }
        [JsonPropertyName("end")] public object EndMapping => End.Value;
        ...
        [JsonIgnore] public OneOf<object, object[], string[]> Position { get; set; }
        [JsonPropertyName("position")] public object PositionMapping => Position.Value;
        ...
        [JsonPropertyName("background")] public AnnotationBackgroundCfg Background { get; set; }
        [JsonPropertyName("maxLength")] public int? MaxLength { get; set; }
        [JsonPropertyName("autoEllipsis")] public bool? AutoEllipsis { get; set; }

        [JsonPropertyName("ellipsisPosition")]
        public object EllipsisPosition { get; set; } //todo: AntDesign documentation lacking example

        [JsonPropertyName("isVertical")] public bool? IsVertical { get; set; }
        [JsonPropertyName("text")] public AnnotationTextCfg Text { get; set; }
        [JsonPropertyName("top")] public bool? Top { get; set; }
        [JsonPropertyName("animate")] public bool? Animate { get; set; }
        [JsonPropertyName("animateOption")] public IAnimation AnimateOption { get; set; }
        [JsonPropertyName("src")] public string Src { get; set; }
        [JsonPropertyName("autoAdjust")] public bool? AutoAdjust { get; set; }
        [JsonPropertyName("point")] public DataMarkerPointCfg Point { get; set; }
        [JsonPropertyName("line")] public DataMarkerLineCfg Line { get; set; }
        ...
        [JsonIgnore] public OneOf<object, string> Render { get; set; } //todo incomplete/missing examplen
